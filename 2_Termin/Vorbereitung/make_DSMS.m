    ...
    switch target
        ...
        case 'mfun_model'
            ...
            try
                ...
                blockHandle.Script = ['function [SC_state_dot] = dyn_fun(SC_state, SC_input_0, SC_param_0)', char(10), '    SC_state_dot = zeros(4, 1);', char(10), '    SC_state_x_0 = SC_state(1:4);', char(10), '    SC_eval = zeros(4,1);', char(10), '    SC_eval(1) = SC_state_x_0(3);', char(10), '    SC_eval(2) = SC_state_x_0(4);', char(10), '    t1 = 0.1e1 / CM;', char(10), '    t2 = SC_param_0(1);', char(10), '    t6 = SC_input_0(1) / t2 * t1;', char(10), '    t7 = t2 ^ 2;', char(10), '    t9 = SC_state_x_0(2) * SC_param_0(2);', char(10), '    t12 = t1 / t7;', char(10), '    SC_eval(3) = t12 * t9 + t6;', char(10), '    t16 = SC_param_0(3) ^ 2;', char(10), '    t17 = t16 * ms;', char(10), '    SC_eval(4) = -t6 - (CM * t7 + CA + t17) * t12 / (t17 + CA) * t9;', char(10), '    SC_state_dot(1:4) = SC_eval(1:4);', char(10), 'end'];
                blockHandle.Inputs(end-0).Scope = 'Parameter';
                blockHandle.Inputs(end-0).Props.Array.Size = '[6]';
                ...
                if ~verLessThan('matlab','9.4')
                    ...
                    model_ws_h.assignin('params', zeros(6, 1));
